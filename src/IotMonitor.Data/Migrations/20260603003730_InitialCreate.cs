        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceTypeCode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EndpointPath = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "DeviceTypes",
                columns: new[] { "Code", "Lifecycle", "Name", "Protocol" },
                values: new object[,]
                {
                    { "BARRERA_MODBUS", 2, "Barrera Modbus", "Modbus TCP" },
                    { "CAMARA_HTTP", 2, "Camara HTTP", "HTTP" },
                    { "CARTEL_UDP", 3, "Cartel UDP", "UDP" },
                    { "SEMAFORO_MODBUS", 2, "Semaforo Modbus", "Modbus TCP" },
                    { "SENSOR_MODBUS", 1, "Sensor Modbus", "Modbus TCP" }
                });
